...
<form    method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<div class="form-group">
      <label>Lenght</label>
      <input type="text" class="form-control" id="first" placeholder="Enter lenght" name="lenght">
    </div>

    <div class="form-group">
      <label>ENTER SECOND VALUE</label>
      <input type="text" class="form-control" id="second" placeholder="Enter width" name="width">
    </div>
